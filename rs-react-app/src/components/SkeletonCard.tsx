...
export const SkeletonCard: React.FC = () => {
  return (
    <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg w-full max-w-xs h-[420px] flex flex-col">
      <div className="w-full h-64 bg-gray-700 animate-pulse flex-shrink-0"></div>
